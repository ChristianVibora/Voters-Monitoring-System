...
<html>
<head>
<title>Birthday Celebrants</title>
...
<div id="cssmenu">
				...
				<li><a href="welcome.php"><span>Home</span></a></li>
				   ...
				   <li class="active"><a href="birthday-celebrants.php"><span>Birthday Celebrants</span></a></li>
...
<center>
<form method="POST" action="birthday-celebrants.php" class="printignore">
<table>
<tr>
<td>
<label>Select Birthdays From: </label>
</td>
<td>
...
<tr>
<td>
<label>Select Birthdays To: </label>
</td>
<td>
...
<input type="submit" name="search_birthdays" value="Search">
</td>
</tr>
</table>
</form>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	if (isset($_POST["search_birthdays"])) {
		generate_birthday_celebrants_list($_POST["date_from"], $_POST["date_to"]);
	}
}

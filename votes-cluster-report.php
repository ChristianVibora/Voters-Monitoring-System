...
<html>
<head>
<title>Tags By Cluster Report</title>
...
<center>
<?php $clusters = Clusters::view_all_clusters(); 
$votes = Votes::view_votes_by_cluster($clusters);
?>
<table class="list">
<tr class="list-header">
<th>Precinct Number</th><th>Barangay</th><th>5 Tags & Above</th><th>4 Tags</th><th>3 Tags</th><th>2 Tags</th><th>1 Tags</th><th>0 Tags</th><th>Total</th>
</tr>
<?php
$total_overall_voters = $total_votes_0 = $total_votes_1 = $total_votes_2 = $total_votes_3 = $total_votes_4 = $total_votes_5 = 0;

 for ($i=0;$i<count($votes);$i++) {
	$total_voters = Voters::count_voters("voter_cluster", $clusters[$i]->get_cluster_id());
...
?>
<tr class="list-row">
<td><?php echo $clusters[$i]->get_precint_number(); ?></td>
<td><?php echo Barangays::view_barangay_name_by_id($clusters[$i]->get_cluster_barangay()); ?></td>
